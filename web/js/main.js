...
document.getElementById("Condenser_script").addEventListener("click", ()=>{eel.Condenser_script()}, false);
...
document.getElementById("QualityTool_script").addEventListener("click", ()=>{eel.QualityTool_script()}, false);
